...
tasks = [
    # 主要功能需求
    {"Task": "xx需求", "Start": "2025-03-10", "End": "2025-03-10", "Category": "功能需求", "Milestone": True},
    {"Task": "xxxx卡需求", "Start": "2025-04-08", "End": "2025-04-08", "Category": "功能需求", "Milestone": True},
    
    # UI走查问题修复
    {"Task": "UI走查问题修复 P0", "Start": "2025-04-21", "End": "2025-04-21", "Category": "UI走查问题修复", "Milestone": True},
    {"Task": "UI走查问题修复 P1,P2", "Start": "2025-05-23", "End": "2025-05-23", "Category": "UI走查问题修复", "Milestone": True},
    {"Task": "xxxx卡需求", "Start": "2025-04-08", "End": "2025-04-08", "Category": "功能需求", "Milestone": True},
    {"Task": "xx功能以及优化", "Start": "2025-05-24", "End": "2025-06-09", "Category": "功能需求", "Milestone": True},

    {"Task": "xx未发车文案状态优化", "Start": "2025-06-11", "End": "2025-06-13", "Category": "功能需求", "Milestone": True},
        
    
    
    # 其他零散需求
    {"Task": "xx出车状态增加目的地", "Start": "2025-04-21", "End": "2025-04-21", "Category": "其他零散需求", "Milestone": True},
    {"Task": "xx提示", "Start": "2025-05-12", "End": "2025-05-12", "Category": "其他零散需求", "Milestone": True},
    {"Task": "xx端/xx端firbase崩溃处理", "Start": "2025-05-13", "End": "2025-05-14", "Category": "其他零散需求", "Milestone": False},
    {"Task": "xx听单优化", "Start": "2025-06-10", "End": "2025-06-12", "Category": "其他零散需求", "Milestone": False},
    {"Task": "xxxx", "Start": "2025-06-13", "End": "2025-06-13", "Category": "其他零散需求", "Milestone": False},
    {"Task": "性能监控修改Matrxi库", "Start": "2025-06-20", "End": "2025-06-21", "Category": "其他零散需求", "Milestone": True},
    {"Task": "性能OOM监控", "Start": "2025-06-22", "End": "2025-06-23", "Category": "其他零散需求", "Milestone": True},
    {"Task": "性能崩溃监控", "Start": "2025-06-24", "End": "2025-06-25", "Category": "其他零散需求", "Milestone": True},
    {"Task": "性能卡顿、耗时监控dump文件解析堆栈", "Start": "2025-06-25", "End": "2025-06-26", "Category": "其他零散需求", "Milestone": True},
    {"Task": "包瘦身优化之重复资源处理", "Start": "2025-06-26", "End": "2025-06-26", "Category": "其他零散需求", "Milestone": True},
    {"Task": "包瘦身优化之图片批量压缩脚本", "Start": "2025-06-27", "End": "2025-06-27", "Category": "其他零散需求", "Milestone": True},
    {"Task": "包瘦身优化之无用图片和无用代码脚本扫描", "Start": "2025-06-30", "End": "2025-06-30", "Category": "其他零散需求", "Milestone": True}
...
# 按类别排序
categories = ["功能需求", "UI走查问题修复", "其他零散需求"]
...
# 固定非黄色配色，避免黄色背景
colors = {
    '功能需求': {'main': '#4ECDC4', 'light': '#C7F2EF', 'dark': '#3AA39C'},
    'UI走查问题修复': {'main': '#5B8FF9', 'light': '#D6E4FF', 'dark': '#3D5A99'},
    '其他零散需求': {'main': '#9D65C9', 'light': '#E5D4F0', 'dark': '#7D51A1'}
}
...
# 设置图表标题和标签
plt.title('项目需求上线时间表 (2025年3月-6月)', fontsize=18, fontweight='bold', pad=20)
plt.xlabel('上线日期', fontsize=12, labelpad=10)

# 添加图例
milestone_marker = plt.Line2D([0], [0], marker='D', color='w', markerfacecolor='gray', 
                             markersize=10, label='上线日期')
normal_patch = mpatches.Patch(color='gray', label='持续任务', alpha=0.7)
...
# 保存高分辨率图片到桌面
output_path = os.path.expanduser('/Users/jack.cai/Desktop/project_timeline.png')
